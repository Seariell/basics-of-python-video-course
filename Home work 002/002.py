...
mounths = {'01': 'января', '02': 'февраля', '03': 'марта', '04': 'апреля', '05': 'мая', '06': 'июня', '07': 'июля',
           '08': 'августа', '09': 'снтября', '10': 'октября', '11': 'ноября', '12': 'декабря'}

date = input('Введите дату в формате dd.mm.yyyy, например: 02.11.2013: ')

date_list = date.split('.')
day = days[date_list[0]]
mounth = mounths[date_list[1]]
print('Вы ввели: {} {} {} года'.format(day, mounth, date_list[2]))